...
their methods raise NotImplementedError. GeminiProvider is a real
implementation; not unit-tested here.
"""
import pytest

from sheela.llm.anthropic import AnthropicProvider
from sheela.llm.base import LLMProvider, Message, ResponseChunk
